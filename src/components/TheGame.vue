...
const saveScores = ref(false); // Flag for HighScores component to save scores
    ...
    <div class="flex flex-col items-start gap-8 md:flex-row">
      <div class="w-64 rounded-lg bg-emerald-800 p-6">
        <HighScores
          ...
          :new-game-started="!gameIdle"
          v-if="props.localStorageAvailable"
        ></HighScores>
        <div v-else>No high scores available</div>
      </div>
      <!-- Game Board -->
